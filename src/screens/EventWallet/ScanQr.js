...
import { Text, View, StyleSheet, StatusBar,
  Button ,TextInput,KeyboardAvoidingView, Platform,AppState,TouchableOpacity,Image} from 'react-native';
import LinearGradient from 'react-native-linear-gradient';

 import { BarCodeScanner } from 'expo-barcode-scanner';
 import {transaction,checkDevice,signOut} from "../API/ApiActions";
...
export default class ScanQR extends Component{
  ...
  //  });
   ...
   var tok= this.props.navigation.getParam("balance" , "")
   if(tok==0)
   {
     this.setState({
       tokens:''
  ...
  console.log("tokenss  "+ this.props.navigation.getParam("balance" , "00"))
  ...
  scanQR =(data) =>{
    ...
    transaction(params)
     ...
     .catch(e => { 
       this.setState({ loading: false })
       alert("Customer can not pay to creator")
       console.log("error", e);
     });
...
render(){
  ...
  console.log("tokensss "+ this.state.tokens)
